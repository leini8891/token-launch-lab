...
Token Launch Lab is an adversarial agent harness, not another friendly chatbot. It coordinates agents that try to break a launch from different angles: dump risk, protocol risk, regulatory risk, and crypto Twitter narrative attacks.

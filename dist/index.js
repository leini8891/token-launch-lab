...
async function runDemoAgent() {
    ...
    await writeMarkdown(path.join(root, "README.md"), `# Agent Pod Harness
...
Read \`PITCH.md\`.
`);
    await writeMarkdown(path.join(root, "PITCH.md"), `I built Agent Pod because AI coding tools still often behave like one contractor. But real product work needs roles: someone clarifies the spec, someone builds, someone audits, and someone packages the story.
